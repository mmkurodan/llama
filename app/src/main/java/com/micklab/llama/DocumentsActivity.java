...
public class DocumentsActivity extends Activity {
    ...
    private String buildJapanesePrivacyText() {
        ...
        sb.append("- ログファイル（ollama.log、Javaクラッシュ時は last_crash.txt、ネイティブクラッシュ時は native_crash.txt、診断情報は diagnostics/process_diagnostics.log・diagnostics/last_state.txt・best effort の diagnostics/recent_logcat.txt。process_diagnostics.log には生成開始/終了に加えて native-call-start / native-call-end の段階ログも出力）\n\n");
    ...
    private String buildEnglishPrivacyText() {
        ...
        sb.append("- Log files (ollama.log, last_crash.txt for Java crashes, native_crash.txt for native crashes, and diagnostics/process_diagnostics.log plus diagnostics/last_state.txt with a best-effort diagnostics/recent_logcat.txt. process_diagnostics.log now also records native-call-start / native-call-end generation stages)\n\n");
