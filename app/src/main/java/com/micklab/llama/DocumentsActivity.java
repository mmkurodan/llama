...
public class DocumentsActivity extends Activity {
    ...
    private String buildJapaneseManualText() {
        ...
        sb.append("4. 設定画面の操作\n");
        sb.append("- 設定画面: 各項目は種別ごとのセクションに分かれており、見出しをタップすると開閉できます。\n");
    ...
    private String buildEnglishManualText() {
        ...
        sb.append("- Settings screen: Controls are grouped into collapsible sections. Tap a section title to expand or collapse it.\n");
